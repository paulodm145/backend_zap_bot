...
process.env.INTEGRACOES_CREDENCIAIS_CRIPTOGRAFIA_CHAVE =
...
process.env.EVOLUTION_API_KEY = 'chave-global-de-teste';
process.env.EVOLUTION_WEBHOOK_URL_BASE = 'http://api.test';
